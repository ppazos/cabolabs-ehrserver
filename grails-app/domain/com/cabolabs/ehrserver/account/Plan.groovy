...
class Plan {
   ...
   int repo_total_size_in_kb // we use the international system unit kilo: 1 kB = 1000 bytes (and 1 KB = 1 KiB = 1024 bytes)
   ...
   static constraints = {
      period(inList: Plan.periods.values() as List)
      name(unique: true)
   }
