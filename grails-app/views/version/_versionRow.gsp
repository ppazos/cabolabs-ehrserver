...
<tr>
  ...
  <td align="center">
    ...
    <g:link controller="ehr" action="showComposition" params="[uid:cindex.uid]" title="${message(code:'versionRow.action.showXML')} ${cindex.uid}" target="_blank"><asset:image src="xml.png" class="icon" /></g:link>
