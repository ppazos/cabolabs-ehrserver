...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
  <head>
    ...
    <asset:javascript src="jquery-3.4.0.min.js" />
        ...
        <div class="col-md-4 col-md-offset-4">
          <div class="login-panel panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form action="${createLink(controller:'auth', action:'auth')}" method="POST" id="loginForm" class="cssform" autocomplete="off">
                <fieldset>
                  <div class="form-group">
                    <label for="email"><g:message code="auth.login.email.label"/></label>
                    <input type="email" class="form-control" name="email" id="email" required="required" />
                  </div>
                  <div class="form-group">
                    <label for="password"><g:message code="auth.login.password.label"/></label>
                    <input type="password" class="form-control" name="pass" id="pass" required="required" value="" />
                  </div>
                  <%--
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" class="chk" name="${rememberMeParameter}" id="remember_me" <g:if test="${hasCookie}">checked="checked"</g:if>/>
                      <g:message code="auth.login.remember.me.label"/>
                    </label>
                  </div>
                  --%>
                  ...
                  <fieldset>
                    <div class="form-group" style="margin:0; padding-top:15px; text-align:center; border-top:1px solid #ccc;">
                      <g:link controller="user" action="register">
                        <b><g:message code="auth.login.register.label"/></b>
                      </g:link>
                    </div>
                  </fieldset>
                </g:if>
