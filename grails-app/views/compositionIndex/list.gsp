...
<html>
  ...
  <body>
    <!--
    <a href="#list-compositionIndex" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
      ...
      <table>
        <thead>
          <tr>
            ...
            <g:sortableColumn property="ehrId" title="${message(code: 'compositionIndex.ehrId.label', default: 'Ehr Id')}" />
          
            <g:sortableColumn property="subjectId" title="${message(code: 'compositionIndex.subjectId.label', default: 'Subject Id')}" />
