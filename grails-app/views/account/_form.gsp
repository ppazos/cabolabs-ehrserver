...
<div class="form-group ${hasErrors(bean: account, field: 'enabled', 'error')} ">
  ...
  <g:textField name="companyName" value="${account?.companyName ?: params.companyName}" required="" class="form-control" />
</div>
...
<g:if test="${actionName=='create'||actionName=='save'}">
   ...
   <div class="form-group ${hasErrors(bean: account?.contact, field: 'username', 'error')} required">
     ...
     <g:textField name="username" required="" value="${account?.contact?.username ?: params.username}" class="form-control" />
   </div>
   ...
   <div class="form-group ${hasErrors(bean: account?.contact, field: 'email', 'error')} required">
     ...
     <g:textField name="email" required="true" value="${account?.contact?.email ?: params.email}" class="form-control"/>
   </div>
