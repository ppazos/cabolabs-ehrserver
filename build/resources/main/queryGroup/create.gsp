...
<html>
  <head>
    ...
    <title><g:message code="queryGroup.create.label" /></title>
  </head>
  <body>
    <div class="row">
      <div class="col-lg-12">
        <h1><g:message code="queryGroup.create.label" /></h1>
      </div>
    </div>
    <div class="row row-grid">
      <div class="col-lg-12">
        ...
        <g:form url="[resource:queryGroupInstance, action:'createGroup']" >
          <fieldset class="form">
