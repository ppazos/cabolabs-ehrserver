          ...
          <div class="panel-body">
            <g:form class="form filter" action="index">
              ...
              <div class="form-group">
                <label for="ipt_un"><g:message code="user.attr.email" /></label>
                <input type="text" class="form-control" name="email" id="ipt_un" value="${params?.email}" />
              </div>
            ...
            <table class="table table-striped table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <g:sortableColumn property="email" title="${message(code: 'user.attr.email', default: 'Email')}" />
