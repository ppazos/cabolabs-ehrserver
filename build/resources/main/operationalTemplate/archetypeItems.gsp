...
<html>
  <head>
    ...
    <title><g:message code="opt.optArchItems.title" /></title>
  </head>
  <body>
    <div class="row">
      <div class="col-lg-12">
        <h1><g:message code="opt.optArchItems.title" /></h1>
      </div>
    </div>
      ...
      <div class="col-lg-12">
        ...
        <div class="table-responsive">
           <table class="table table-striped table-bordered table-hover">
		        <thead>
		          <tr>
		            <g:sortableColumn property="archetypeId" title="${message(code: 'template.archetypeId.label', default: 'archetypeId')}" params="[uid: templateInstance.uid]" />
		        ...
		        <tbody>
			        <g:each in="${items}" status="i" var="item">
			          <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
			            <td>${fieldValue(bean: item, field: "archetypeId")}</td>
